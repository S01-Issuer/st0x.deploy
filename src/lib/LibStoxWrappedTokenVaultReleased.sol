...
/// @title LibStoxWrappedTokenVaultReleased
/// @notice Every frozen release of `StoxWrappedTokenVault`: one entry per file in
...
library LibStoxWrappedTokenVaultReleased {
