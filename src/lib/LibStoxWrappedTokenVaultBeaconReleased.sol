...
/// @title LibStoxWrappedTokenVaultBeaconReleased
/// @notice Every frozen release of `StoxWrappedTokenVaultBeacon`: one entry per file in
...
library LibStoxWrappedTokenVaultBeaconReleased {
