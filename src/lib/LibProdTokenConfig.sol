...
library LibProdTokenConfig {
    ...
    function productionTokenConfigs() internal pure returns (TokenConfig[] memory configs) {
        ...
        configs[29] = TokenConfig("FTF", "Franklin Limited Duration Income Trust ST0x", "tFTF");
    }
}
