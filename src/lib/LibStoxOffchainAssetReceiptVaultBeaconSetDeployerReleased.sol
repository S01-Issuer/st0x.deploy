...
/// @title LibStoxOffchainAssetReceiptVaultBeaconSetDeployerReleased
/// @notice Every frozen release of `StoxOffchainAssetReceiptVaultBeaconSetDeployer`: one entry per file in
...
library LibStoxOffchainAssetReceiptVaultBeaconSetDeployerReleased {
