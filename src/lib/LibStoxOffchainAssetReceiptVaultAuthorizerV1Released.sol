...
/// @title LibStoxOffchainAssetReceiptVaultAuthorizerV1Released
/// @notice Every frozen release of `StoxOffchainAssetReceiptVaultAuthorizerV1`: one entry per file in
...
library LibStoxOffchainAssetReceiptVaultAuthorizerV1Released {
