...
/// @title LibStoxWrappedTokenVaultBeaconSetDeployerReleased
/// @notice Every frozen release of `StoxWrappedTokenVaultBeaconSetDeployer`: one entry per file in
...
library LibStoxWrappedTokenVaultBeaconSetDeployerReleased {
