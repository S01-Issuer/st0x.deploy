...
/// @title LibStoxCorporateActionsFacetReleased
/// @notice Every frozen release of `StoxCorporateActionsFacet`: one entry per file in
...
library LibStoxCorporateActionsFacetReleased {
