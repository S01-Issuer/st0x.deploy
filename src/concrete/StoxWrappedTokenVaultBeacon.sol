...
/// @dev Constructor passes `LibProdDeployV4.STOX_WRAPPED_TOKEN_VAULT_0_1_2` as the
...
contract StoxWrappedTokenVaultBeacon is
    UpgradeableBeacon(LibProdDeployV4.STOX_WRAPPED_TOKEN_VAULT_0_1_2, LibProdDeployV4.BEACON_INITIAL_OWNER)
{}
