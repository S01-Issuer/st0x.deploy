...
/// @dev Constructor passes `LibProdDeployV4.STOX_WRAPPED_TOKEN_VAULT_RAIN_VATS_0_1_6` as the
...
contract StoxWrappedTokenVaultBeacon is
    UpgradeableBeacon(LibProdDeployV4.STOX_WRAPPED_TOKEN_VAULT_RAIN_VATS_0_1_6, LibProdDeployV4.BEACON_INITIAL_OWNER)
{}
