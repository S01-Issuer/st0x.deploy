...
/// @notice Pre-flight failed: a contract of the audited 0.1.8 orchestrator
/// closure has no runtime code at its pinned address on the active chain.
/// Ship the closure first via `manual-sol-artifacts-0-1-8.yaml`.
...
/// match its 0.1.8 pin — something other than the audited bytecode sits at
/// the pinned address.
/// @param pinned The pinned closure address inspected.
/// @param expected The pinned 0.1.8 codehash.
...
/// Pre-requisite per chain: the audited 0.1.8 orchestrator closure must be
/// live (`manual-sol-artifacts-0-1-8.yaml`) — pre-flight enforces it by
...
contract DeployOrchestrator is Script {
    ...
    /// audited 0.1.8 codehash.
    /// @param pinned The pinned closure address.
    /// @param codehash The pinned 0.1.8 codehash.
    ...
    /// @notice Assert the full audited 0.1.8 orchestrator closure is live on
    ...
    function _assertClosureReady() internal view {
        ...
        _assertClosureContract(LibProdDeployV4.STOX_RECEIPT_0_1_8, LibProdDeployV4.STOX_RECEIPT_CODEHASH_0_1_8);
        _assertClosureContract(
            LibProdDeployV4.STOX_RECEIPT_VAULT_0_1_8, LibProdDeployV4.STOX_RECEIPT_VAULT_CODEHASH_0_1_8
        );
        _assertClosureContract(
        ...
        _assertClosureContract(
            LibProdDeployV4.ST0X_ORCHESTRATOR_0_1_8, LibProdDeployV4.ST0X_ORCHESTRATOR_CODEHASH_0_1_8
        );
        _assertClosureContract(
