...
contract BuildPointers is Script {
    ...
    /// @notice Header of every `*.pointers.sol` file. Kept here verbatim so the
    /// pointer files stay byte-identical to the frozen `src/generated/<tag>/`
    /// snapshots regardless of what `LibCodeGen.filePrefix` emits upstream.
    string constant POINTER_FILE_PREFIX = "// SPDX-License-Identifier: LicenseRef-DCL-1.0\n"
        "// SPDX-FileCopyrightText: Copyright (c) 2020 Rain Open Source Software Ltd\n" "pragma solidity ^0.8.25;\n\n"
