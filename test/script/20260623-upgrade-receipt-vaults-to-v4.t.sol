...
/// clone).
///
/// @dev RED until the swap bundle executes on Base — vaults report the
/// retired V3 authoriser until then. This PR merges after the swap; the
/// red is the pre-authored post-state pin.
///
