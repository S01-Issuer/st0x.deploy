...
contract DeployOrchestratorTest is Test {
    ...
    /// @notice Etch every closure contract's frozen 0.1.8 runtime bytecode
    ...
    function etchClosure() internal {
        ...
        vm.etch(LibProdDeployV4.STOX_RECEIPT_0_1_8, LibProdDeployV4.STOX_RECEIPT_RUNTIME_CODE_0_1_8);
        vm.etch(LibProdDeployV4.STOX_RECEIPT_VAULT_0_1_8, LibProdDeployV4.STOX_RECEIPT_VAULT_RUNTIME_CODE_0_1_8);
        vm.etch(
        ...
        vm.etch(LibProdDeployV4.ST0X_ORCHESTRATOR_0_1_8, LibProdDeployV4.ST0X_ORCHESTRATOR_RUNTIME_CODE_0_1_8);
        vm.etch(
    ...
    /// 0.1.8 implementation under the pinned owner.
    function mockBeaconSet() internal {
        ...
        vm.mockCall(
            ...
            abi.encode(LibProdDeployV4.ST0X_ORCHESTRATOR_0_1_8)
        );
        vm.mockCall(
            LibOrchestratorInvariants.ST0X_ORCHESTRATOR_BEACON,
    ...
    function testClosureRefusesABlankChain() external {
        vm.expectRevert(
            abi.encodeWithSelector(ClosureNotDeployed.selector, LibProdDeployV4.STOX_CORPORATE_ACTIONS_FACET_0_1_8)
        );
    ...
    function testClosureChecksEveryContract() external {
        etchClosure();
        vm.etch(LibProdDeployV4.ST0X_ORCHESTRATOR_BEACON_SET_DEPLOYER_0_1_8, "");
        vm.expectRevert(
            abi.encodeWithSelector(
                ClosureNotDeployed.selector, LibProdDeployV4.ST0X_ORCHESTRATOR_BEACON_SET_DEPLOYER_0_1_8
            )
        );
        harness.assertClosureReady();
    }
    ...
    /// not enough, the codehash must be the audited 0.1.8 one.
    function testClosureRefusesWrongBytecode() external {
        etchClosure();
        vm.etch(LibProdDeployV4.ST0X_ORCHESTRATOR_0_1_8, hex"fe");
        vm.expectRevert(
            abi.encodeWithSelector(
    ...
    /// Closure pre-flight passes with the frozen 0.1.8 runtime at every pin.
    ...
    function testRefusesWhenInstanceAlreadyDeployed() external {
        ...
        harness.assertNoInstanceYet(LibProdDeployV4.ST0X_ORCHESTRATOR_BEACON_SET_DEPLOYER_0_1_8);
    }
    ...
    function testRefusesUnexpectedSetDeployerNonce() external {
        address setDeployer = LibProdDeployV4.ST0X_ORCHESTRATOR_BEACON_SET_DEPLOYER_0_1_8;
    ...
    function testOrchestratorBeaconPin() external pure {
        assertEq(
            ...
            vm.computeCreateAddress(LibProdDeployV4.ST0X_ORCHESTRATOR_BEACON_SET_DEPLOYER_0_1_8, 1),
    ...
    function testOrchestratorInstancePin() external pure {
        assertEq(
            ...
            vm.computeCreateAddress(LibProdDeployV4.ST0X_ORCHESTRATOR_BEACON_SET_DEPLOYER_0_1_8, 2),
