...
/// `LibProdDeployV4.STOX_CORPORATE_ACTIONS_FACET_0_1_1` address.
///
...
contract StoxReceiptVaultFallbackRoutingTest is Test {
    ...
    function testDirectCallToFacetRevertsWithFacetMustBeDelegatecalled() external {
        ICorporateActionsV1 facetDirect = ICorporateActionsV1(LibProdDeployV4.STOX_CORPORATE_ACTIONS_FACET_0_1_1);
