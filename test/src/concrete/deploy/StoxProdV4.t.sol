...
contract StoxProdV4Test is Test {
    ...
    /// the pinned codehash, and that the wrapped-token-vault beacon points at
    /// the V4 vault implementation and is still held by the beacon initial
    /// owner (pre-migration deploy state).
